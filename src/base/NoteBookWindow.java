...
public class NoteBookWindow extends Application {
	...
	private HBox addHBox() {
		...
		hbox.getChildren().addAll(buttonLoad, buttonSave, searchLabel, searchField, searchButton, clearButton);
	...
	private void updateListView(String currentSearch) {
